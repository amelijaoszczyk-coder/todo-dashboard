# todo-dashboard
A single-file todo manager planner app used for time-management with live chart visualisations, built as a frontend companion to a Node.js/Express REST API course on Udemy.
